"""
Standalone tests for bank chart validators (no DB required).
"""
...
from validators.bank_chart import (
    ALLOWED_METRICS,
...
def test_valid_chart_data(valid_chart_data):
...
def test_metric_name_normalization(valid_chart_data):
...
def test_invalid_metric_name(valid_chart_data):
...
def test_empty_metric_name(valid_chart_data):
...
def test_empty_bank_name(valid_chart_data):
...
def test_missing_plotly_data(valid_chart_data):
...
def test_empty_plotly_data(valid_chart_data):
...
def test_missing_time_range_start(valid_chart_data):
...
def test_sql_query_too_long(valid_chart_data):
...
def test_interpretation_too_long(valid_chart_data):
...
def test_bank_name_trimming(valid_chart_data):
...
def test_validate_valid_content(valid_chart_data):
...
def test_validate_invalid_content(valid_chart_data):
...
def test_validate_missing_required_field(valid_chart_data):
