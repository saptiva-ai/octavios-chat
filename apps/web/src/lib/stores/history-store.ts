...
interface HistoryState {
  ...
  createConversationOptimistic: (tempId?: string, createdAt?: string, idempotencyKey?: string, selectedModel?: string, draftTools?: Record<string, boolean>) => string
...
export const useHistoryStore = create<HistoryState>()(
  devtools(
    (set, get) => ({
      ...
      createConversationOptimistic: (providedTempId?: string, providedCreatedAt?: string, providedIdempotencyKey?: string, selectedModel?: string, draftTools?: Record<string, boolean>) => {
        const generatedKey =
