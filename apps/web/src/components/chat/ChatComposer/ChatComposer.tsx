...
function SearchIcon() {
  return (
    <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
      ...
      <line x1="16.5" y1="16.5" x2="20" y2="20" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  )
}
...
function DriveIcon() {
  return (
    <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
      <path d="M7 3h10l4 7-4 7H7l-4-7 4-7Z" strokeWidth="1.8" strokeLinejoin="round" />
...
function CodeIcon() {
  return (
    <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
      <path d="m9 9-3 3 3 3" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      <path d="m15 9 3 3-3 3" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
...
function DocumentIcon() {
  return (
    <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
      <path d="M6 3h9l5 5v11a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2Z" strokeWidth="1.8" />
      <path d="M14 3v5h5" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
...
export function ChatComposer({
  ...
  const visibleToolIds = React.useMemo(() => chipToolIds.slice(0, MAX_VISIBLE_CHIPS), [chipToolIds])
  const hiddenToolCount = chipToolIds.length > MAX_VISIBLE_CHIPS ? chipToolIds.length - MAX_VISIBLE_CHIPS : 0
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-zinc-400">({formatFileSize(attachment.size)})</span>
                    </div>
                    ...
                    {attachment.status === 'error' && attachment.errorMessage && (
                      <p className="mt-1 text-xs text-red-300">{attachment.errorMessage}</p>
                    )}
                  </div>
                  <button
                    type="button"
