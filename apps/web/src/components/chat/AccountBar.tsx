      ...
      <div className="border-t border-border p-4">
        ...
        >
          ...
          <div className="flex-1 min-w-0 text-left">
            <p className="text-sm font-bold text-text truncate">{user.username || user.email}</p>
            <p className="text-xs text-text-muted truncate">{user.email}</p>
          </div>
          {/* Logout icon */}
          <svg className="h-4 w-4 text-text-muted flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor">
