...
docker exec octavios-chat-client-project-api pytest tests/services/test_saptiva_client_retry.py -v

# Ejecutar test suite completa en Docker
docker exec octavios-chat-client-project-api pytest tests/ -v --tb=short
```
